...
```
  npm i @fluidchains/blockcerts-verifier
```

If your project **does not require support for IE11**, you can use the following build:

```html
  <script src="node_modules/@fluidchains/blockcerts-verifier/dist/main.js"></script>
...
```html
  ...
  <script src="node_modules/@webcomponents/webcomponentsjs/webcomponents-loader.js"></script>
  <script src="node_modules/@fluidchains/blockcerts-verifier/dist/ie11.js"></script>
```
